...
local theme = {
    ...
    lxrunner_row_meta_fg = roles.text_muted,
    lxrunner_row_meta_selected_fg = roles.text_muted,
    lxrunner_row_meta_font = "Hack Nerd Font Mono 8",
    lxrunner_row_meta_spacing = 12,
