...
local theme = {
    ...
    lxnotify_selected_border = roles.text_accent,
    ...
    lxdisplay_bg_hover = roles.raised_bg,
    lxdisplay_bg_press = roles.hover_bg,
    ...
    lxbluetooth_icon = "",
    lxbluetooth_popup_placement = "right",
    lxbluetooth_icon_width = 24,
    lxbluetooth_bg_hover = roles.raised_bg,
    lxbluetooth_bg_press = roles.hover_bg,
    lxnetwork_icon = "",
    lxnetwork_popup_placement = "right",
    lxnetwork_icon_width = 30,
    lxnetwork_bg_hover = roles.raised_bg,
    lxnetwork_bg_press = roles.hover_bg,
    ...
    lxpower_bg_hover = roles.raised_bg,
    lxpower_bg_press = roles.hover_bg,
